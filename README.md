...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/hist-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/hist-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add hist hist-base
# for installing globally
pixi global install hist hist-base
```
...
It is possible to list all of the versions of `hist` available on your platform:
...
```
pixi search hist --channel conda-forge
```
